/*
www.hackerrank.com/challenges/day-of-the-programmer/problem
 */
#include <assert.h>
#include <ctype.h>
#include <limits.h>
...
char* dayOfProgrammer(int year) {
    ...
    if ( year < 1918 ) { /* Julian */
        if ( 0==(year%4) ) {
            snprintf(date,32,"12.09.%d",year); /* Leap year */
        } else {
            snprintf(date,32,"13.09.%d",year);
        }
        ...
        snprintf(date,32,"25.09.1918"); /* This is a day off */
    }
