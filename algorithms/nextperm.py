...
# is already the last possible permutation.)
# 
# comp is a comparison function - comp(x, y) returns a negative number if x is 
# considered to be less than y, a positive number if x is considered to be greater 
# than y, or 0 if x is considered to be equal to y.
